...
def loadDataDescribePrompt(inputs): 
  ...
  base_prompt = """
      Provided is an analysis conducted by your data analsyt colleague. Since you have qualitative CONTEXT knowledge about the data, please add your own analysis to the report.

      Be careful to only add context to the provided analysis and do not overly change the subject of the analysis.  
  ...
  inputs = {'analysis': inputs['analysis'], 'context': ''}

  prompt = system_prompt + ' \n\n ' + base_prompt + ' ### \n\n ' + ' ### \n '.join(prompt_vars) + ' ### \n\n ' + 'ANALYSIS:'


  return prompt, inputs, None
